...
@section('breadcrumb')
    <button type="button" class="btn btn-default btn-sm backlink"><i class="fa fa-angle-double-left" aria-hidden="true"></i>
        Back </button>
    <a href="{{ url('admin/activity') }}" class="btn btn-default btn-sm backlink"><i class="fa fa-list"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <div class="bs-component">
                                <input type="text" id="title" name="title" class="form-control" value="{{$data->title}}" placeholder="Title" required/>
                ...
                <div class="sid_bvijay mb10">
                    ...
                    <label class="field select">
                        <select name="activity_parent" required>
                            <option value="expedition" {{ ($data->activity_parent == 'expedition') ? 'selected' : '' }}>Expedition
                            </option>
                            ...
                            <option value="package" {{ ($data->activity_parent == 'package') ? 'selected' : '' }}>Training Package
                            </option>
                        </select>
                        <i class="arrow"></i>
                    </label>
