...
Route::any('book/{uri}', 'FrontendControllers\FrontpageController@showbooking')->name('page.booking');
...
Route::get('activity/{uri}', 'FrontendControllers\FrontpageController@travellist')->name('page.activitydetail');
Route::get('region/{uri}', 'FrontendControllers\FrontpageController@regionlist')->name('page.regionlist');

Route::get('destinations/{uri}', 'FrontendControllers\FrontpageController@destinationtriplist')->name('page.destinationtriplist');
Route::get('expeditions/{uri}', 'FrontendControllers\FrontpageController@expedition')->name('expedition-list');
Route::get('treks/{uri}', 'FrontendControllers\FrontpageController@trekking')->name('trekking-list');
Route::get('packages/{uri}', 'FrontendControllers\FrontpageController@package')->name('package-list');
Route::get('training/{uri}', 'FrontendControllers\FrontpageController@packageDetail')->name('packageDetail');
Route::get('activities/{uri}', 'FrontendControllers\FrontpageController@activities')->name('page.activities');

Route::get('destination-list', 'FrontendControllers\FrontpageController@tour')->name('tour');
...
Route::post('pages/customize-trip', 'FrontendControllers\FrontpageController@customize_trip')->name('customize-trip.post');
...
Route::get('blog/{uri}', 'FrontendControllers\FrontpageController@blog')->name('page.blogdetail');
